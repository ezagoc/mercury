...
table <- stargazer(
  ...
  title = paste0('Panel B, Pooled (Batch 1 and 2) Endline Results for the Ads Treatment in ', 
                 country,
                 ' , (', weeks,')'),
  type = "latex")
...
print(table)
cat(table, file = paste0("../../results/04-analysis/", stage, "/endline_ads_b1_b2_fake_", 
                         country,".tex"))