...
table <- stargazer(
  ...
  title = paste0('Panel C, Pooled (Batch 1) Endline Results for the SMI Treatment in ', 
                 country,
                 ' , (', weeks,')'),
  type = "latex")  %>% 
...
print(table)
cat(table, file = paste0("../../results/04-analysis/",stage,"/endline_table_b1fake__all_", 
                         country,".tex"))