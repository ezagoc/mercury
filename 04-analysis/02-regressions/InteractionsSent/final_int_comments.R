...
for (type in list_types){
  ...
  final <- final |> 
    mutate(Variable = case_when(var == 'ver_rt' ~ paste0(addon, 'Total Comments COVID Posts'),
                                var == 'true_rt' ~ paste0(addon, 'Total Comments Positive COVID Posts'),
                                var == 'fake_rt' ~ paste0(addon, 'Total Comments Neutral COVID Posts'),
                                var == 'n_ver_rt' ~ paste0(addon, 
                                                           'Total Comments Negative COVID Posts')),
