...
for (type in list_types){
  ...
  final <- final |> 
    mutate(Variable = case_when(var == 'ver_rt' ~ paste0(addon, 'Verifiable RTs'),
                                var == 'ver_no_rt' ~ paste0(addon, 
                                                            'Verifiable Posts'),
                                var == 'n_ver_rt' ~ paste0(addon, 'Non Verifiable RTs'),
                                var == 'n_ver_no_rt' ~ paste0(addon, 
  ...
  final_rt$Variable <- factor(final_rt$Variable, levels = c(paste0(addon, 'Number of RTs (English)'),
                                                            paste0(addon, 
                                                                   'Non Verifiable RTs'), 
