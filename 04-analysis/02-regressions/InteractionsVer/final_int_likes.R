...
for (type in list_types){
  ...
  final <- final |> 
    mutate(Variable = case_when(var == 'ver_rt' ~ paste0(addon, 'Total Likes (Verifiable)'),
                                var == 'true_rt' ~ paste0(addon, 'Total Likes (True)'),
                                var == 'fake_rt' ~ paste0(addon, 'Total Likes (Fake)'),
                                var == 'tot' ~ paste0(addon, 'Total Likes (English)'),
  ...
  final$Variable <- factor(final$Variable, levels = c(paste0(addon, 'Total Likes (English)'),
                                                      paste0(addon, 
                                                             'Total Likes (Non-Verifiable)'), 
                                                      paste0(addon, 'Total Likes (Verifiable)'), 
                                                      paste0(addon, 'Total Likes (True)'), 
