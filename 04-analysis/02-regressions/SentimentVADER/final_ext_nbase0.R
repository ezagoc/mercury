...
for (type in list_types){
  ...
  final <- final |> 
    mutate(Variable = case_when(var == 'pos_rt_c' ~ paste0(addon, 'Positive COVID RTs'),
                                ...
                                var == "pos_rt_v" ~ paste0(addon, 'Positive Vaccine RTs'),
                                var == "pos_no_rt_v" ~ paste0(addon, 
                                                              'Positive Vaccine Posts'),
