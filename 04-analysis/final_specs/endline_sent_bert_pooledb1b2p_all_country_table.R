...
for (stage in list('stage1_2')){
  for (type in list('', 'log_', 'arc_')){ 
    ...
    table <- stargazer(
      ...
      label = paste0("tab:endline_table_sent_bert_b1b2p_all_",type,stage),
      header = FALSE,
      ...
      title = paste0('Panel C, Pooled Sentiment (BERT) Analysis Results (Pilot, Batch 1 and 2) for the SMI Treatment in Both Countries', 
                     '(',weeks,')'),
      type = "latex") %>% 
