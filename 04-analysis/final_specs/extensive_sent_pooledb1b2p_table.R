...
for (stage in list('stage1_2', 'stage3_4', 'stage5_6')){
  for (type in list('', 'log_', 'arc_')){ 
    ...
    table <- stargazer(
      ...
      label = paste0("tab:endline_sent_b1b2p_ext_", type, stage),
      header = FALSE,
      ...
      title = paste0('Panel D, Pooled Sentiment (VADER) Analysis Extensive Results (Pilot, Batch 1 and 2) for the SMI Treatment in Both Countries', 
                     '(',weeks,')'),
      type = "latex") %>% 
...
Specifications further include block1 randomization of the influencer FEs. Robust standard errors are in parentheses. 
