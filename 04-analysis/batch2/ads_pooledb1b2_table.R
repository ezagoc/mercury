...
table <- stargazer(
  ...
  label = paste0("tab:endline_ads_b2_",stage,"", country),
  header = FALSE,
  ...
  title = paste0('Panel B, Pooled Endline Results for the Ads Treatment in ', 
                 country,
                 ' , (', weeks,')'),
  type = "latex")
...
print(table)
cat(table, file = paste0("../../results/04-analysis/endline_ads_b1_b2_", stage,"_", 
                         country,".tex"))