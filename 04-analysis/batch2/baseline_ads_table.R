...
table <- stargazer(
  ...
  label = paste0("tab:baseline_ads_", country),
  header = FALSE,
  ...
  title = paste0('Panel B, Baseline for the Ads Treatment in ', country),
  type = "latex")
...
print(table)
cat(table, file = paste0("../../results/04-analysis/baseline_ads_", 
                         country,".tex"))