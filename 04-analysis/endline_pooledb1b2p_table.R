...
pvals = read_excel(paste0("../../data/04-analysis/", country, 
                          "/",stage,"/agg_pvalues_b1_b2_p.xlsx"))
...
table <- stargazer(
  ...
  label = paste0("tab:endline_table_b1_b2_p_",stage,"", country),
  header = FALSE,
  ...
  title = paste0('Panel A, Pooled (Batch 1, 2 and Pilot) Endline Results for the SMI Treatment in ', 
                 country,
                 ' , (', weeks,')'),
  type = "latex")  %>% 
...
print(table)
cat(table, file = paste0("../../results/04-analysis/endline_table_b1_b2_p_fake_", 
                         stage,"_", 
                         country,".tex"))