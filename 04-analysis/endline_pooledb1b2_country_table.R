...
table <- stargazer(
  ...
  label = paste0("tab:endline_table_b1_b2_fake_",stage,"", country),
  header = FALSE,
  ...
  title = paste0('Panel A, Pooled (Batch 1 and 2) Endline Results for the SMI Treatment for Both Countries ', 
                 '(', weeks,')'),
  type = "latex")  %>% 
...
print(table)
cat(table, file = paste0("../../results/04-analysis/",country,"/endline_table_b1_b2_fake_", 
                         stage,".tex"))
