...
pvals = read_excel(paste0("../../data/04-analysis/", country, 
                          "/",stage,"/agg_pvalues_b1_good", base, ".xlsx"))
...
table <- stargazer(
  ...
  label = paste0("tab:endline_table_b1_good_",stage,"", base),
  header = FALSE,
...
print(table)
cat(table, file = paste0("../../results/04-analysis/",country,"/endline_table_b1_",
                         base, stage,".tex"))
