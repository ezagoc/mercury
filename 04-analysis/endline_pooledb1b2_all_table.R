...
table <- stargazer(
  ...
  title = paste0('Panel C, Pooled (Batch 1 and 2) Endline Results for the SMI Treatment in ', 
                 country,
                 ' , (', weeks,')'),
  type = "latex")  %>% 
...
print(table)
cat(table, file = paste0("../../results/04-analysis/",stage,"/endline_table_b1_b2_fake__all_", 
                         country,".tex"))