...
pvals = read_excel(paste0("../../data/04-analysis/", country, 
                          "/",stage,"/agg_pvalues_fake_b1_b2.xlsx"))
...
table <- stargazer(
  ...
  label = paste0("tab:endline_table_b1_b2_",stage,"", country),
  header = FALSE,
  ...
  title = paste0('Panel A, Pooled (Batch 1 and 2) Endline Results for the SMI Treatment in ', 
                 country,
                 ' , (', weeks,')'),
  type = "latex")  %>% 
...
print(table)
cat(table, file = paste0("../../results/04-analysis/endline_table_b1_b2_fake_", 
                         stage,"_", 
                         country,".tex"))