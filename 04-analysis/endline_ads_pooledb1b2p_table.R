...
data <- data |> mutate(strat_block1 = paste0(strat_block1, batch_id))
...
table <- stargazer(
  ...
  title = paste0('Panel B, Pooled (Batch 1, 2 and Pilot) Endline Results for the Ads Treatment in ', 
                 country,
                 ' , (', weeks,')'),
  type = "latex")
