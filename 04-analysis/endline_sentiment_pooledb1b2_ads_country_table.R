...
table <- stargazer(
  ...
  label = paste0("tab:endline_ads_sent_b1b2_",stage,"", country),
  header = FALSE,
  ...
  title = paste0('Panel B, Sentiment Analysis Results (Batch 1 and 2) for the Ads Treatment for Both Countries (', 
                 weeks,')'),
  type = "latex")
...
print(table)
cat(table, file = paste0("../../results/04-analysis/",country,"/endline_ads_sent_b1b2_", 
                         stage,".tex"))