...
path_out <- paste0('../../data/03-experiment/',country,
                   '/treatment/followers/00-raw/tweets_batch2/june/')
path_no_tweets <- paste0('../../data/03-experiment/',country,
                         '/treatment/followers/00-raw/tweets_batch2/no_tweets_june/')
...
path_invalids <- paste0('../../data/03-experiment/', country,
                        '/treatment/followers/00-raw/tweets_batch2/invalids/')
# Dates:

start =  '2023-05-29T00:00:00Z'
